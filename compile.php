...
$exer_id = isset($_POST['exer_id']) ? $_POST['exer_id'] : '';// Ham isset cua PHP kiem tra bien co null khong de tranh loi
...
if($check>0 && strlen($filename)>0){
	...
	$res =  shell_exec('fpc temp/'.$filename) . '';// Ham shell_exec goi lenh compile
